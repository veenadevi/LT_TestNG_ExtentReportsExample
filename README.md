# ExtentReport Sample with  Java TestNG Selenium
...
2. Project Dependencies
    ...
    * Check that packages are available
    ```
    $ cd LT_TestNG_ExtentReportsExample
    ```
...
### Test Results
    After Execution, Extent Report html files can be viewed under extent-reports folder
```
## About LambdaTest
